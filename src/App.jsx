...
const GeminiModal = ({ isOpen, onClose, title, prompt, type }) => {
  ...
  const fetchGeminiResponse = async (apiKey) => {
    ...
    const systemInstruction = type === 'recipe' 
      ...
      : type === 'form' 
      ? "You are an elite strength coach. Provide 3-4 critical, actionable form cues for the exercise to maximize hypertrophy and safety. Also explain the steps and how to do that specific exercise. Be concise and authoritative."
